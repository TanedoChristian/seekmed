...
export default function AdminSideNav({ setTableCategory, category }) {
    return (
        <div class="w-96 p-4 bg-white flex-col justify-start items-start gap-6 inline-flex">
            <div class="w-full">
                ...
                <ul class="flex-col gap-1 flex">
                    <li
                        onClick={() => setTableCategory("inventory")}
                    ...
                    <li
                        onClick={() => setTableCategory("riders")}
                        className="cursor-pointer"
                    >
                        <a>
                    ...
                    <li
                        onClick={() => setTableCategory("accounts")}
                        className="cursor-pointer"
                    >
                        <a>
                            <div class="flex-col gap-1 flex">
                                ...
                                >
                                    <div class="h-5 gap-3 flex">
                                        <div class="relative">
                                            <Person2Outlined className="text-gray-500" />
                                        </div>
                                        <h2 class="text-gray-500 text-sm font-medium leading-snug">
                                            Create Admin
                                        </h2>
                    ...
                    <li
                        onClick={() => setTableCategory("reviews")}
                        className="cursor-pointer"
                    >
                        <a>
                            <div class="flex-col gap-1 flex">
                    ...
                    <li
                        onClick={() => setTableCategory("reports")}
                        className="cursor-pointer"
                    >
                        <a>
                            <div
