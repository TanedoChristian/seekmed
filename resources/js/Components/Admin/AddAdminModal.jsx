...
export default function AddAdminModal({ setAdmins }) {
    const {
        register,
        handleSubmit,
        reset,
    ...
    const onSubmit = async (data) => {
        axios.post("/store/admin", data).then(({ data: newData }) => {
            Swal.fire({
                title: "Added!",
                text: `Admin is added to the database`,
                icon: "success",
            });
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogTrigger asChild>
                <Button className="bg-main text-white">+ Add More Admin</Button>
            </DialogTrigger>
